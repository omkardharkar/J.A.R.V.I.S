...
engine.setProperty('voice',voices[0].id) #int '0' for 'David'(male) voice index '1' for 'zira'(female) voice
...
class MainThread(QThread):
    ...
    #function commands  to convert voice into text
    ...
    def run_jarvis(self):
        ...
        while True:
            ...
            #Say : JARVIS open facebook (or) JARVIS open social media facebook 
            ...
            #It can close : caliculator, notepad,paint, discord, spotify ,vscode(aka editor), steam, VLC media player
            ...
            #Eg: Jarvis play music
                ...
                try:
                    music_dir = 'C:\\Users\\Omkar\\Music' #change the song path directory if you have songs in other directory
    ...
    def Fun(self,command):
        ...
        if 'your name' in command:
            ...
            self.talk("your name is Omkar")
        elif 'university name' in command:
            self.talk("you are studing in Parul University, with batchelor in Computer Application and Cloud Computing") 
...
class Main(QMainWindow):
    ...
    def startTask(self):
        self.ui.movie = QtGui.QMovie(rf"C:\Users\Omkar\Desktop\Project-II\J.A.R.V.I.S\UI\ironman1.gif")
        self.ui.label_2.setMovie(self.ui.movie)
        self.ui.movie.start()
        self.ui.movie = QtGui.QMovie(rf"C:\Users\Omkar\Desktop\Project-II\J.A.R.V.I.S\UI\ringJar.gif")
        self.ui.label_3.setMovie(self.ui.movie)
        self.ui.movie.start()
        self.ui.movie = QtGui.QMovie(rf"C:\Users\Omkar\Desktop\Project-II\J.A.R.V.I.S\UI\circle.gif")
        self.ui.label_4.setMovie(self.ui.movie)
        self.ui.movie.start()
        self.ui.movie = QtGui.QMovie(rf"C:\Users\Omkar\Desktop\Project-II\J.A.R.V.I.S\UI\lines1.gif")
        self.ui.label_7.setMovie(self.ui.movie)
        self.ui.movie.start()
        self.ui.movie = QtGui.QMovie(rf"C:\Users\Omkar\Desktop\Project-II\J.A.R.V.I.S\UI\ironman3.gif")
        self.ui.label_8.setMovie(self.ui.movie)
        self.ui.movie.start()
        self.ui.movie = QtGui.QMovie(rf"C:\Users\Omkar\Desktop\Project-II\J.A.R.V.I.S\UI\circle.gif")
        self.ui.label_9.setMovie(self.ui.movie)
        self.ui.movie.start()
        self.ui.movie = QtGui.QMovie(rf"C:\Users\Omkar\Desktop\Project-II\J.A.R.V.I.S\UI\powersource.gif")
        self.ui.label_12.setMovie(self.ui.movie)
        self.ui.movie.start()
        self.ui.movie = QtGui.QMovie(rf"C:\Users\Omkar\Desktop\Project-II\J.A.R.V.I.S\UI\powersource.gif")
        self.ui.label_13.setMovie(self.ui.movie)
        self.ui.movie.start()
        self.ui.movie = QtGui.QMovie(rf"C:\Users\Omkar\Desktop\Project-II\J.A.R.V.I.S\UI\ironman3_flipped.gif")
        self.ui.label_16.setMovie(self.ui.movie)
        self.ui.movie.start()
        self.ui.movie = QtGui.QMovie(rf"C:\Users\Omkar\Desktop\Project-II\J.A.R.V.I.S\UI\Sujith.gif")
